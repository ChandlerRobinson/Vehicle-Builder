...
class Cli {
  ...
  async chooseVehicle(): Promise<void> { // Change return type to Promise<void>
    const answers = await inquirer.prompt([ // Use await here
      {
        type: 'list',
  ...
  // Update this method to be async
  async createVehicle(): Promise<void> { // Change return type to Promise<void>
    const answers = await inquirer.prompt([ // Use await here
      {
        type: 'list',
        name: 'vehicleType',
  ...
  async createCar(): Promise<void> { // Change return type to Promise<void>
    const answers = await inquirer.prompt([ // Use await here
      {
        type: 'input',
        name: 'color',
  ...
  async createTruck(): Promise<void> { // Change return type to Promise<void>
    const answers = await inquirer.prompt([ // Use await here
      {
        type: 'input',
        name: 'color',
  ...
  async createMotorbike(): Promise<void> { // Change return type to Promise<void>
    const answers = await inquirer.prompt([ // Use await here
      {
        type: 'input',
        name: 'color',
  ...
  async findVehicleToTow(truck: Truck): Promise<void> { // Change return type to Promise<void>
    const answers = await inquirer.prompt([ // Use await here
      {
        type: 'list',
        name: 'vehicleToTow',
  ...
  // Update this method to be async
  async performActions(): Promise<void> { // Change return type to Promise<void>
    const answers = await inquirer.prompt([ // Use await here
      {
        type: 'list',
        name: 'action',
  ...
  // Update this method to be async
  async startCli(): Promise<void> { // Change return type to Promise<void>
    const answers = await inquirer.prompt([ // Use await here
      {
        type: 'list',
        name: 'CreateOrSelect',
